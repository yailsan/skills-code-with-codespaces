...
1. Select the **Codespaces** tab to show the list of created Codespaces.
   ...
   <img width="250" alt="list of codespaces" src="https://github.com/yailsan/skills-code-with-codespaces/blob/main/.github/images/codespaces-list.png?raw=true" />

1. Find the active entry, select the three dot menu `...`, and select the **Delete** command.

   <img width="500" alt="delete codespace command" src="https://github.com/yailsan/skills-code-with-codespaces/blob/main/.github/images/delete-codespace-command.png?raw=true" />
